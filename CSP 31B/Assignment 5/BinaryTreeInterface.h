...
public:
	...
	//if a tree contains an item, replace the item with replacementItem
	virtual bool replace(const ItemType& item, const ItemType& replacementItem) = 0;
	...
	virtual void inorderIterativeTraversal(void visit(ItemType&)) const = 0;
