...
public:
	...
	//replace the item with the searchKey with the replacementItem
	virtual bool replace(const KeyType& searchKey, const ItemType& replacementItem) = 0;
	...
	virtual void traverse(void visit(Entry<int, std::string>&)) const = 0;
